...
I was to write a program in a language that I hadn't used before, and have it completed by the end of the semester (3 months) 

Language and topic were up to the student, so I selected Python as my language, and a basic save file transfer tool as my topic.
...
gci parsing is a solved problem, but since this was an academic project I wanted to rely on external code as little as possible. This ended up costing me quite a bit of time, and as such I wasn't able to implement some final features (as well as cleanup.)
